...
kubectl delete pods,svc,deployments,pvc --all --force --grace-period=0 2>/dev/null || true
kubectl delete pods,svc,deployments,pvc --all --force --grace-period=0 --all-namespaces 2>/dev/null || true
