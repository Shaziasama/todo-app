...
Please remember that I am still encountering the "Shell executable 'powershell.exe' not found" error, so I will provide the content for files and you will need to manually create them and execute commands.